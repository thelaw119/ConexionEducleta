...
<html class="no-js" lang="es-CL">
    ...
    <head>
        ...
        <script type='text/javascript' src='../../js/editar_admin.js'></script>
                                ...
                                <div class="collapse navbar-collapse navbar-ex1-collapse">
                                    <ul id="menu-mainmenu" class="nav navbar-nav">
                                        <li id="menu-item-644"
                                            ...
                                            <a title="Inicio" href="http://192.168.100.2/conexioneducleta/vista/admin/admin.php" >Inicio</a>
                                        </li>
                                        <li id="menu-item-644"
                                        ...
                                        <li id="menu-item-642"
                                            ...
                                            <a title="Mis Pedidos" href="#" onclick="javascript:pedidos();">Pedidos</a>
                                        </li>
                                        <li id="menu-item-893"
