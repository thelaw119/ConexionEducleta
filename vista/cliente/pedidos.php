...
inner join productos on productos.id_producto = compras.id_producto where usuarios.id_usuario = $codigo";
...
?>
        ...
        <div class="row" align="Center">
            ...
            <h1 class="page-description text-center">MIS PEDIDOS</h1>
...
<?php }else{
    ?>
        ...
        <div class="row" align="Center">
            ...
            <h1 class="page-description text-center">NO TIENES COMPRAS REALIZADAS</h1>
